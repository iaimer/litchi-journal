...
当前工作区说明：`1.7.1` 在 `1.7.0` 的专注计时、首页习惯体验和习惯趋势页基础上，补齐了记录编辑页复用新增页、编辑状态保护与标签兼容；当前工作区另有标签管理页精简与本机闭环改动，尚未发布新版本。当前分支已完成代码验证，版本号已更新；Release APK 已按本版本重新构建，不安装到真机。
...
- 习惯追踪交互：饮水、步数进度条与每日目标设置；点击饮水进度条可快捷添加或自定义三个常用水量，运动使用成长绿色
